...
public class AsyncSubjectExActivity extends AppCompatActivity {
    ...
    private void doSomeWork() {
        ...
        source.subscribe(getSecondObserver());// it will emit 4 and onComplete for second observer also.
        source.onNext(4);
        source.onComplete();
    }
